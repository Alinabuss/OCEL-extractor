...
def OCEL_GEN_GEN_extractor(dataset_folder, level, api_type = "openai", openai_api_key = None, openai_model = "gpt-3.5-turbo", azure_api_key = None,  azure_endpoint = None, azure_model = None):
...
if __name__ == "__main__":
    ...
    OCEL_GEN_GEN_extractor(dataset_folder, level='Test_setup', api_type = "azure", azure_api_key = azure_api_key, azure_endpoint = azure_endpoint, azure_model = azure_model)
    end_time = time.time()
